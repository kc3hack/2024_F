...
そのあと問題に出たものの詳細説明．読んでくれると嬉しいなぁ．  

10問終わると結果が表示されるよ．  
  
結果画面で関西コイン(ゲーム内マネー)とカードが入手できるよ．  
ゲームの説明以上  
...
UIの観点ではバックで処理している時間をプログレスバーで表示することでユーザがあとどれ位待てばいいかを可視化することや,単純な操作をすることにこだわり,分かりにくく余計な操作が内容に工夫した.  
